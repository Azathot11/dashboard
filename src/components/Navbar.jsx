...
import { setResize } from '@syncfusion/ej2/spreadsheet';
      ...
      <div className="flex">
        ...
        <TooltipComponent content="profile" position="BottomCenter">
          ...
          >
            ...
            <p>
              <span className='text-gray-400 text-14'>Hi,</span>{' '} <span className='text-gray-400 font-bold ml-1 text-14'>Paulio</span>
            </p>
